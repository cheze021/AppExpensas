...
class ExampleTest {
    ...
    fun expense_model_list(){
        ...
        val expense = Expense(id = 1, amount = 4.50, category = ExpenseCategory.CAR, description = "Combustible")
    ...
    fun expense_model_param_success() {
        // Given
        val expenseList = mutableListOf<Expense>()
        val expense = Expense(id = 1, amount = 4.50, category = ExpenseCategory.OTHER, description = "Combustible")
        val expense2 = Expense(id = 2, amount = 8.340, category = ExpenseCategory.OTHER, description = "Limpieza")
